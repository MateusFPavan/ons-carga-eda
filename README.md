...
│   ├── figures/            # 9 result charts
│   ├── ESCOPO.md, 00–07_*.md  # scope + exploratory investigation reports
│   ├── tabela_comparativa.csv
│   ├── tabela_custo_assimetrico.csv
│   ├── tabela_vies_direcional.csv
│   └── tabela_breakdown_erro.csv
...
[Technical report](docs/technical_report.md) · [Model card](docs/MODEL_CARD.md) · [Data card](docs/DATA_CARD.md) · [Setup](docs/SETUP.md) · [Evaluator requirements](docs/evaluator_requirements.md) · [One-pager](references/one_pager.md)

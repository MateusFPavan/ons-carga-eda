...
from modelo_naive import (  # noqa: E402
    CARGA_SE_PATH, CUSTO_DIR, INICIO_AVALIACAO, N_AMOSTRAS_VAZAMENTO, SEED_VAZAMENTO,
    ...
    gerar_origens, previsor_naive, rodar_walkforward, testar_vazamento, valores_equivalentes,
